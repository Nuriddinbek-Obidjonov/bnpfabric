import sofa3Img from '../assets/sofa3.png'
...
function Sofa3() {
  ...
  return (
    <div className='container pt-10'>
        <div className='rounded-[25px] mt-20 mb-10 hover:shadow-[0_35px_60px_-15px_rgba(255,0,0,0.6)]' style={{background: 'linear-gradient(#007303, #6CB26E, #024304)'}}>
          <div className='text-center md:text-left text-white flex flex-col md:flex-row items-center justify-around px-10 py-10 md:py-0'>
            ...
            <div className='order-1 md:basis-1/4 md:order-2' data-aos='fade-down'>
              <img className='h-[300px] scale-x-[1.2] scale-y-[1.3] md:scale-y-[1.4] lg:scale-y-[1.6] translate-y-[-80px] md:translate-y-[0]' src={sofa3Img} alt='sofa image' />
            </div>
