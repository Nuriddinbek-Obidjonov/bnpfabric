...
function Sofa2() {
  ...
  return (
    <div className='container py-10'>
        <div className='rounded-[25px] mt-20 hover:shadow-[0_35px_60px_-15px_rgba(255,0,0,0.6)]' style={{background: 'linear-gradient(#6D00CD, #BD80EC, #3E0075)'}}>
          <div className='text-center md:text-left text-white flex flex-col md:flex-row items-center justify-around px-10 py-10 md:py-0'>
            ...
            <div className='order-1 md:basis-1/4 md:order-2' data-aos='fade-down'>
              <img className='h-[300px] scale-x-[1.2] scale-y-[1.3] md:scale-y-[1.4] lg:scale-y-[1.6] translate-y-[-80px] md:translate-y-[0]' src={sofa2Img} alt='sofa image' />
            </div>
